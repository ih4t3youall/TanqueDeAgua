...
Sistema de dos nodos comunicados por radio. El nodo del tanque recibe las
órdenes de la web por WiFi y las reenvía a la bomba por radio (ya no mide el
nivel: se quitó el sensor). El nodo de la bomba es esclavo: solo obedece.
...
| **Módulo de relé de 1 canal** (5V, optoacoplado) | 1 | Para las luces. IN al GPIO 25; COM/NO en serie con la fase de las luces. Para cargas grandes, que maneje un contactor. |
...
Es un proyecto económico: ESP32 + Nano + 2 módulos NRF24 +
